...
from aircraft_modules.new_propulsion.components.nozzle import Nozzle
...
aircraft_module_config = "new_propulsion"
...
propulsion_module = aircraft.get_new_propulsion_module()
